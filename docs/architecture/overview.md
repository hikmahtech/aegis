...
|-------------|------|------------|-----------------|
| **Sebas** | Executive assistant | `smart` | `GmailIngestFlow`, `CalendarIngestFlow`, `TodoistSyncFlow`, `ClarifyFlow`, `DailyReviewFlow` + `WeeklyReviewFlow`, `SocialPublishFlow`, `MemoryReflectionFlow`, `CuriosityCardFlow`, `ProfileReflectionFlow`, `ExpiryRadarFlow`, `WearableIngestFlow` |
